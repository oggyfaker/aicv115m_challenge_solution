...
class Hybrid_GemP_CNN14_8hz(nn.Module):
    def __init__(self, 
        ...
        if WeightsEffv2 != None:
            ...
            print("No Loading Weights Gem4hz base !! --> Submit mode")
    ...
    def forward(self,input1, input2, SpecAugment=False):        
        ...
        batch_size = feature_2["feature_core"].shape[0]
        embedding_combine = torch.cat((feature_1,  self.GeM_Pooling(feature_2["feature_core"]).view(batch_size, -1)), 1)
