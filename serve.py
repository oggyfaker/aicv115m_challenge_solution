"""
Script serving  API by FruitAI
Creator: Tony Do
Contact: vanhuong.do@asicland.com
Date of created: 5th Sept 2021
"""
import time
import json
import uvicorn
...
async def predict_assessment(meta: Metadata = Form(...), audio_file: UploadFile = File(None, media_type='audio/wav')):
    ...
    assessment = predict(file_path)
    execution_time = round(time.time() - timestamp,4)
